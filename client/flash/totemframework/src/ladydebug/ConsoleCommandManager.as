package ladydebug
{
	...
	{
		ladydebug_internal var commands : Dictionary = new Dictionary();
		...
		public function init() : void
		{
			registerCommand( "help", function( prefix : String = null ) : void
			{
				...
				if ( prefix == null )
				{
					Logger.print( ConsoleMobile, "Keyboard shortcuts: " );
					Logger.print( ConsoleMobile, "[SHIFT]-TAB - Cycle through autocompleted commands." );
					Logger.print( ConsoleMobile, "PGUP/PGDN   - Page log view up/down a page." );
					Logger.print( ConsoleMobile, "" );
				}

				// Display results.
				Logger.print( ConsoleMobile, "Commands:" );
				...
				for ( var i : int = 0; i < commandList.length; i++ )
				{
					...
					Logger.print( ConsoleMobile, "   " + cc.name + " - " + ( cc.docs ? cc.docs : "" ));
				}
