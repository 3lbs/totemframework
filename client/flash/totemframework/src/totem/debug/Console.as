...
package totem.debug
{
	...
	import totem.core.TotemSet;
	import totem.core.input.KeyboardKey;
	import totem.core.input.KeyboardManager;
	 ...
	 */
	public class Console extends Sprite implements ILogAppender, ITicked, ITotemManager
	{
		...
		public function listDirectory() : void
		{
			...
			{
				var potentialGroup : TotemGroup = _currentGroup.getSmashObjectAt( i ) as TotemGroup;
		...
		public function changeDirectory( dir : String = null ) : void
		{
			...
			else
			{
				...
				{
					potentialGroup = _currentGroup.getSmashObjectAt( i ) as TotemGroup;
				...
				{
					_currentGroup = _currentGroup.getSmashObjectAt( dirAsNumber ) as TotemGroup;
