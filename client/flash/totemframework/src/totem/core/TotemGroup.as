...
package totem.core
{
	...
	public class TotemGroup extends TotemObject
	{
		...
		/**
		 *
		 * @param name Name of totem entity
		 * @return Boolean test if totem entity exsists
		 *
		 */
		public function hasEntity(name:String):Boolean
		{
			return getInjector().hasMapping(TotemEntity, name);
		}
		...
		protected function addChildObject(object:TotemObject, name:String):void
		{
			...
			//?
			childInjector.map(TotemEntity, name).toValue(object);
