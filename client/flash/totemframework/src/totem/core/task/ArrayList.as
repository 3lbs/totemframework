...
package totem.core.task
{
	...
	public class ArrayList implements IList
	{
		...
		public function appendAll( l : IList ) : void
		{
		...
		public function insertAll( index : uint, l : IList ) : void
		{
			if ( index < 0 || index > _array.length )
			{
				throw new IllegalArgumentError( "insert: index out of range: " + index );
		...
		{
			return ArrayUtil.removeItem( _array, item );
		}
		...
		public static function wrap( arr : Array ) : IList
		{
			var l : ArrayList = new ArrayList();
			l._array = arr;
			return l;
