	...
	public class Animator extends EventDispatcher
	{
		...
		public function animate( elapsed : Number ) : void
		{
			...
			if ( _elapsedTime > _duration )
			{
				...
				dispatchEvent( new AnimatorEvent( AnimatorEvent.ANIMATION_REPEATED_EVENT, this ));
			}
		...
		public function finish() : void
		{
			...
			dispatchEvent( new AnimatorEvent( AnimatorEvent.ANIMATION_FINISHED_EVENT, this ));
		}
		...
		public function play() : void
		{
			...
			if ( _elapsedTime == 0.0 )
				dispatchEvent( new AnimatorEvent( AnimatorEvent.ANIMATION_STARTED_EVENT, this ));
			else
				dispatchEvent( new AnimatorEvent( AnimatorEvent.ANIMATION_RESUMED_EVENT, this ));
		}
		...
		public function stop() : void
		{
			...
			dispatchEvent( new AnimatorEvent( AnimatorEvent.ANIMATION_STOPPED_EVENT, this ));
		}
