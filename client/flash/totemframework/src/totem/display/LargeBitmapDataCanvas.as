...
package totem.display
{
	...
	public class LargeBitmapDataCanvas extends TSprite
	{
		...
		public function LargeBitmapDataCanvas( w : Number, h : Number, transparent : Boolean = false, color : uint = 0xffffff )
		{
			_width = w;
			_height = h;
