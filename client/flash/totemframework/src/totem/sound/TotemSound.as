package totem.sound
{
	...
	public class TotemSound extends RemovableEventDispatcher
	{
		 ...
		 */
		internal var soundInstances:Vector.<SoundInstance>;
		...
		public function play():SoundInstance
		{
			return new SoundInstance(this, true, true);
		}
		 ...
		 */
		public function createInstance(autoplay:Boolean = false,autodestroy:Boolean = true):SoundInstance
		{
			return new SoundInstance(this, autoplay, autodestroy);
		}
		...
		protected function onIOError(event:ErrorEvent):void
		{
			...
			_ioerror = true;
			dispatchEvent(new TotemSoundEvent(TotemSoundEvent.SOUND_ERROR, this, null) as Event);
		}
		...
		public function get instances():Vector.<SoundInstance>
		{
			return soundInstances.slice();
		}
		
		public function getInstance(index:int):SoundInstance
		{
