package totem.sound
{
	...
	public class TotemSoundEvent extends Event
	{
		...
		public var soundInstance:SoundInstance;
		...
		public function TotemSoundEvent(type:String, sound:TotemSound, soundinstance:SoundInstance,soundID:int = -1, bubbles:Boolean = true, cancelable:Boolean = false) 
		{
