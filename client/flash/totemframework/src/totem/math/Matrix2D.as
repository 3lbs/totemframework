...
package totem.math
{
	...
	public class Matrix2D
	{
		 ...
		 *
		 */
		public function Set( a1 : Number = 1, a2 : Number = 0, a3 : Number = 0, b1 : Number = 0, b2 : Number = 1, b3 : Number = 0, c1 : Number = 0, c2 : Number = 0, c3 : Number = 1 ) : void
		{
			this.a1 = a1;
			this.a2 = a2;
			this.a3 = a3;
		...
		{
			multiply ( new Matrix2D ( a_fwd.x, a_fwd.y, 0, a_side.x, a_side.y, 0, 0, 0, 1 ) );
		}
