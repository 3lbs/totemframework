...
package gorilla.resource
{
    ...
    import gorilla.resource.providers.EmbeddedResourceProvider;
    
    import ladydebug.Logger;
    
	use namespace gorilla_internal;
    /**
    ...
    public class ResourceBundle
    {
        ...
        public static var ExtensionTypes:Object = {
            png:"gorilla.resource.ImageResource",
            jpg:"gorilla.resource.ImageResource",
            gif:"gorilla.resource.ImageResource",
            bmp:"gorilla.resource.ImageResource",
            xml:"gorilla.resource.XMLResource",
			json:"gorilla.resource.JSONResource",
            swf:"gorilla.resource.SWFResource",
            ...
            for each (var v:XML in desc.variable)
            {
                ...
                if (resTypeName == "")
                {
                    ...
                    if ( !ExtensionTypes.hasOwnProperty(ext) )
                    {
                        ...
                        resTypeName = "gorilla.resource.DataResource";
                    }
                    else
                    {
                ...
                EmbeddedResourceProvider.getInstance().registerResource( resSource, resType, new res() );
            }
        }                  
    }
}
