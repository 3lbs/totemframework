...
public class RecursiveGroupPipeline implements IPipeline {

  private var group:BindGroup;
  private var next:IPipeline;

  public function RecursiveGroupPipeline( group:BindGroup, next:IPipeline ) {
    this.group = group;
    this.next = next;
  }

  public function run( args:Array ):void {
    group.callRecursively(next.run, args);
  }
