...
package org.as3commons.lang
{
	...
	public final class StringUtils
	{
		...
		public static function toKeyValueString( properties : Object ) : String
		{
			var str : String = "";
			...
			for ( var i : String in properties )
			{
				...
				sorted.push({ key: i, value: properties[ i ]});
			}
			...
			var groups : String = sorted[ 0 ].key.split( "." )[ 0 ];
			...
			for each ( var n : Object in sorted )
			{
				key = n.key;
				g = key.split( "." )[ 0 ];
				...
				keyPadded = rightPadChar( key, length, " " );
				row = keyPadded + ": " + n.value;
				str += row + WIN_BREAK;
			}
