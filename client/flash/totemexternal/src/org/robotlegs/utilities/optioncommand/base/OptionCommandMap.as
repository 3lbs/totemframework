package org.robotlegs.utilities.optioncommand.base
{
	...
	import org.robotlegs.utilities.optioncommand.core.IOptionCommandMap;
	...
	public class OptionCommandMap extends CommandMap implements IOptionCommandMap
	{
		...
		protected function noMoreCommandsForEvent( eventType : String, eventClass : Class ) : Boolean
		{
			...
			if ( dictionaryIsEmpty ( callbacksByCommandClass ) )
				return true;
			return false;
		}
