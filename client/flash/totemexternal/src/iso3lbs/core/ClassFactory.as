...
package iso3lbs.core
{
	...
	import iso3lbs.utils.ClassFactory;
	import iso3lbs.utils.IMXMLObject;
	 ...
	 *  of type IFactory.</p>
	 */
	public class ClassFactory extends iso3lbs.utils.ClassFactory implements IMXMLObject
	{
		/**
		 * Constructor
		 *
		...
		override public function newInstance() : *
		{
			...
			if ( instance is EventDispatcher )
			{
				...
				for each ( descriptor in eventListenerDescriptors )
					EventDispatcher( instance ).addEventListener( descriptor.type, descriptor.listener );
			}
